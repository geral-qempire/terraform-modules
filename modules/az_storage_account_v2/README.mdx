...
module "region_abbreviations" {
  source = "git::https://github.com/geral-qempire/terraform-modules.git?ref=modules/az_region_abbreviations_v2/v1.0.0"
}

module "storage_account" {
  source = "git::https://github.com/geral-qempire/terraform-modules.git?ref=modules/az_storage_account_v2/v1.0.0"
...
| `enable_geo_priority_replication` | `bool` | `false` | no | Toggle Geo Priority Replication for blob storage using AzAPI. |
